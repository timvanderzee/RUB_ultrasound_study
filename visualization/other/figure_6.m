...
PEN = Fdat.Region.PEN;
FL = Fdat.Region.FL * 476 / 50.7 / pixpermm;
...
RMSE = [sqrt(mean((FL(FasData.digitizedFrames)' - mean(Flength,2)).^2,'omitnan')) sqrt(mean((PEN(FasData.digitizedFrames)' - mean(Fangle,2)).^2,'omitnan'))]
